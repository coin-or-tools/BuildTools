...
[ case "$CXX" in
    ...
    cl* | */cl* | CL* | */CL* | icl* | */icl* | ICL* | */ICL*) 
	  ...
	  -e 's%$AR x \\$f_ex_an_ar_oldlib%bla=\\`lib -nologo -list \\$f_ex_an_ar_oldlib echo '"$mydos2unix"' | xargs \\`; echo \\$bla; for i in \\$bla; do lib -nologo -extract:\\$i \\$f_ex_an_ar_oldlib; done%' \
